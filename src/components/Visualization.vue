	...
	<div class="visualization">
		...
		<nav aria-label="breadcrumb">
			<ol class="breadcrumb">
				...
				>{{ n.name }}</li>
				<div class="ml-auto subtotal">{{ $util.groupNums(node.value, true, ['', 'ezer', 'millió']) }}</div>
			</ol>
		</nav>
				...
				<div class="d-flex flex-column flex-grow-1">
					...
					>
						<div class="text-right w-100">
							<span class="d-inline d-sm-none font-weight-bold">{{ $util.groupNums(n.value, true, ['', 'ezer', 'millió']) }}</span>
							<span class="d-none d-sm-inline">{{ $util.groupNums(n.value, true, ['', 'ezer', 'millió']) }}</span>
